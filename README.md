...
[![Rust Safety Dance](https://img.shields.io/badge/unsafe-forbidden-success.svg)](https://github.com/rust-secure-code/safety-dance/)
[![GitHub License](https://img.shields.io/github/license/DavidLokison/configops)](https://github.com/DavidLokison/configops/blob/main/LICENSE)
[![Crates.io Version](https://img.shields.io/crates/v/configops)](https://crates.io/crates/configops)
[![Crates.io Size](https://img.shields.io/crates/size/configops)](https://crates.io/crates/configops)
...
## Motivation
### Based on [`confy`] but without the clutter
Yes, [`confy`] already does an excellent job at providing management for config files, but its strict dependency on a specific structure bugged me a little. You can only provide one file type feature flag, the [`etcetera`] strategy is hardcoded to a specific top level domain and author and which feature flag you choose implicitely influences the file type extension.
